...
<table class="table table-sm table-bordered mymargin5">
	...
	<tr  height="40">
		...
		<td align="left">
			<?	
				if ($row["sm"]==1) echo("<input type='radio' name='sm' value='0'>양력 <input type='radio' name='sm' value='1' checked>음력");
				else echo("<input type='radio' name='sm' value='0' checked>양력 <input type='radio' name='sm' value='1'>음력");
			?>
		</td>
	</tr>
	<tr>
