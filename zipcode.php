...
<?
	...
	$zip_kind = $_REQUEST["zip_kind"] ? $_REQUEST["zip_kind"] : 0;
...
<div class="row m-0">
	<div class="col bg-light" align="center">
		...
		<h2 class="m-3" style="font-size: 30px"><font color='#AF2031'>우편번호 찾기</font></h2>
	</div>	
...
<div class="row m-1 mb-0">
	<div class="col" align="center">
		...
		<div align="left">
			<font size="2" color="#666666"><b>검색할 도로명이나 건물명 일부를 입력해주세요.</b></font>
			<div class="d-inline-flex mt-1">
				<div class="input-group input-group-sm">
					...
					<a href="javascript:SearchZip()" class="btn btn-sm btn-outline-secondary text-white" 
		...
		<font size="2" color="#666666"><b>나머지 주소를 입력해주세요.</b></font>
		</form>
		<br><br>
