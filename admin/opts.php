...
<?
	...
	$sql = "select * from opts where opt_id=$id order by id";
...
<div class="row mx-1  justify-content-center">
	...
	<div class="row myfs13">
		<div class="col" align="left" style="padding-top:8px"">
			&nbsp;옵션명 : <font color="red"><?=$optname; ?></font>
		</div>
	...
	<table class="table table-sm table-bordered table-hover my-1">
		...
		<tr>
			...
			<td>
				...
				<a href="opts_delete.php?id=<?=$id; ?>&id1=<?=$id1; ?>" class="btn btn-sm mybutton-red" onclick="javascript:return confirm('삭제할까요?');">삭제</a>				
			</td>
		</tr>
		<?
			}
